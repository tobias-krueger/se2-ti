...
import control.AmpelsteuerungEinfach;

/**
 *
 * @author kremer
 */
public class AmpelsteuerungEinfachView extends javax.swing.JFrame {

    /**
     * Creates new form uebung01View
     */
    
    AmpelsteuerungEinfach as = new AmpelsteuerungEinfach();
    Thread t;
    
    public AmpelsteuerungEinfachView() {
        initComponents();
        t = new Thread(as);
    }
    ...
    private void initComponents() {
        ...
        lbl_clearlog.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
